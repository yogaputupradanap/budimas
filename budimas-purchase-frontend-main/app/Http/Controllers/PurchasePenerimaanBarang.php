...
class PurchasePenerimaanBarang extends Controller {

    public function index() {
        return view('contents.penerimaan-barang-list', [
            'breadcrumb' => ['Penerimaan Barang', 'Daftar Order']
        ]);
    }
    public function laporan() {
        return view('contents.transaksi-laporan', [
            'breadcrumb' => ['Purchase', 'Laporan']
        ]);
    }
    ...
    public function create(Request $data) {
        ...
        return view('contents.penerimaan-barang-add', [
            'breadcrumb' => ['Penerimaan Barang', 'Form Penerimaan'],
            'data'       => (object) [ 
    ...
    public function store(Request $data) {
         ...
         * @return Illuminate\View\View `Form Request Order`.
         */
        (new HTTPRequest)->url('/api/extra/purchase-transaksi/proses/penerimaan-barang')
                         ->insert($data->all())->response;
