...
<script src="{{ asset('assets-panel/dist/js/pages/vue-apps/components/InfiniteSelect.js') }}"></script>
\
<script src="{{ asset('assets-panel/dist/js/pages/vue-apps/components/select2-serverside.js') }}"></script>
