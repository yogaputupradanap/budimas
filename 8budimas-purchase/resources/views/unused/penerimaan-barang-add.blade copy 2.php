...
<div class="container-fluid">
    <div class="row m-md-1">
        <div class="col-md-12">
            <form action="/penerimaan-barang/store" method="POST">
                @csrf
                <!-- ============================================== -->
                        ...
                        <div class="form row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="idProsesDiselesaikan" value="101">
                                    <input type="hidden" name="idOrder" value="{{ $data->order->id }}">
                                    <input type="text" name="kodeOrder" value="{{ $data->order->kode }}" class="form-control-modal" placeholder="Max 50 Karakter" readonly required>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="waktu" value="{{ $data->order->waktu }}">
                                    <input type="text" name="tanggal" value="{{ $data->order->tanggal }}" class="form-control-modal datepicker" placeholder="YYYY-MM-DD" readonly required>
                                </div>
                                <div class="form-group">
                                    <label>Pilih <em>Principal</em></label>
                                    <select2 name="idPrincipal" v-model="principal.id" :options="principal.text" :readonly="true" required></select2>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea type="text" name="keterangan" class="form-control-modal" maxlength="100" placeholder="Max 100 Karater!" readonly>{{ $data->order->keterangan }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="form row">
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <label>PIC <em>Penerima</em></label>
                                    <input type="hidden" name="idUserJabatan" v-model="user.data.selected.id_jabatan">
                                    <select2 name="idUser" v-model="user.id" :options="user.text" :readonly="true" required></select2>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="tanggal" value="{{ date('Y-m-d') }}" class="form-control-modal datepicker" placeholder="YYYY-MM-DD" readonly required>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="noBatch" value="{{ $data->order->batch_pengiriman + 1}}" class="form-control-modal" placeholder="Number" readonly required>
                                </div>
                                <div class="form-group">
                                    <label>Keterangan <em>Penerimaan</em></label>
                                    <textarea type="text" name="keterangan" class="form-control-modal" maxlength="100" placeholder="Max 100 Karater!"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <table class="table w-130">
                                    <thead>
                                        <tr>
                                            ...
                                            <th> Jumlah <br><em>Penerimaan</em>   </th>
                                            <th> No <br><em>Batch</em>            </th>
                                            <th> Tanggal <br><em>Expired</em>     </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr v-for="(item, index) in produk.table.data" :key="item.id">
                                            ...
                                            <td width='12%'> <input type="text" name="jumlahDiterima[]" value="" class="form-control-modal" placeholder="" required>                                  </td>
                                            <td width='15%'>
                                                ...
                                                <input type="text" name="noBatch[]" value="" class="form-control-modal" placeholder=""> 
                                            </td>
                                            <td width='13%'><input type="text" name="tanggalTerima[]" value="{{ date('Y-m-d') }}" class="form-control-modal datepicker" placeholder="YYYY-MM-DD"></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div class="form row">
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="subtotalTransaksi" class="form-control-modal money" placeholder="Masukkan Subtotal " readonly>
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="form-group">
                                        <label>Potongan</label>
                                        <input type="text" name="potonganTransaksi" class="form-control-modal money" placeholder="Masukkan Potongan ">
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="form-group">
                                        <label>Biaya Lainnya</label>
                                        <input type="text" name="biayaLainnya" class="form-control-modal money" placeholder="Masukkan Biaya Lain-lain">
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text"   name="totalTransaksi" class="form-control-modal money" placeholder="Masukkan Total " readonly>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
    ...
    var app_form = new Vue({ 
        ...
        data    : function() {
            return {
                ...
                cabang    : { text : [], id : '{{ $data->order->id_cabang }}' },
                principal : { text : [], id : '', load : true                 },
                user      : { 
                    id   : '{{ $data->order->id_user }}', 
                    text : [], 
        ...
        watch   : {
            'principal.id' : function(value, value1) {
                app_produk.resetData();
                app_produk.resetSatuan();
                app_produk.setData(value);

                if (this.principal.load && value1 == '') {
                    this.principal.id = "{{ $data->order->id_principal }}";

                } else if (this.principal.load && value1 != '') {
                    app_produk.produk.table.data = @json($data->order_details);
                    this.principal.load = false;
                }
            }
        },
        mounted : function() {
