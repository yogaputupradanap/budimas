...
<template>
  <thead :class="['tw-text-xs tw-sticky tw-top-0 tw-z-10 tw-bg-white', classic && 'tw-border tw-border-gray-300']">
    <tr
      :class="[!classic ? 'tw-shadow-md tw-shadow-black/5' : 'tw-border-b tw-border-gray-300']"
