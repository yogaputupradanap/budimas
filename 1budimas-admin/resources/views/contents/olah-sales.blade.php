            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" v-model="password" class="form-control-modal password"
                                       placeholder="Masukkan Password untuk Login" required>
                            </div>
                            <div class="form-group">
                                <label>Email</label>
                            ...
                            <div class="form-group">
                                ...
                                <textarea v-model="alamat" class="form-control-modal" maxlength="100"
                                          placeholder="Masukkan Alamat (Max 100 Karater)"></textarea>
                            </div>
                            <div class="form-group">
                                <label>Telepon</label>
                        ...
                        <!-- Sales Data Section -->
                        <div class="col-md-6">
                            <h6 class="mb-3">Data Sales</h6>
                            <div class="form-group">
                                <label>Kode Sales</label>
                                <input type="text" v-model="sales_detail.kode_sales" class="form-control-modal"
                                       maxlength="50" placeholder="Masukkan Kode Sales (Max 50 Karakter)" required>
                            </div>
                            <div class="form-group">
                            ...
                            <opsi-wilayah ref="opsi_wilayah" :id1.sync="idWilayah1" @input:id1="idWilayah1 = $event"
                                          :id2.sync="idWilayah2" @input:id2="idWilayah2 = $event">
                            </opsi-wilayah>
                            <div class="form-group">
                                <label>Principal</label>
                                <select2 :multiple="true" :options="principal.data"
                                         v-model="principal.id"
                                         required></select2>
                            </div>
                        </div>
                    </div>
        ...
        var app_list = new Vue({
            ...
            mounted: function () {
                ...
                this.table().on('click', '.btn-delete', (e) => {
                    ...
                    const rowData = this.table().DataTable().row(row)
                        .data();
                    app_form.delete(rowData.id_sales);
                });
            }
        });
    </script>
        ...
        var app_form = new Vue({
            ...
            data: function () {
                return {
                    ...
                    url: {
                        ...
                        show3: "/olah-sales/tipe/data/option",
                        show4: "/olah-principal/data/option",
                        store: "/olah-sales/insert",
                        edit: "/olah-sales/update",
                        delete: "/olah-sales/delete",
                    },
                    // Instance Elemen.
                    form: () => {
            ...
            methods: {
                ...
                resetData: function (data) {
                    ...
                    this.cabang.id = "";
                    this.principal.id = "";
                    this.jabatan.id = 4; // Keep sales jabatan
                    this.nama = "";
                    this.nik = "";
                    this.tanggalLahir = "";
                    this.username = "";
                ...
                setData: function (data) {
                    // Set User Data
                    this.id = data.id;
                    this.idSales = data.id_sales;
                    this.idUser = data.id;
                    this.cabang.id = data.id_cabang;
                    this.principal.id = data.id_principals[0] ? data.id_principals : data.id_principal;
                    this.nama = data.nama;
                    this.nik = data.nik;
                    ...
                    this.sales_detail.kode_sales = data.kode_sales;
                },
                /**
                 * Get Form Data.
                 *
                ...
                getData: function () {
                    return {
                        ...
                        idJabatan: 4, // Always set to sales role
                        nama: this.nama,
                        nik: this.nik,
                        ...
                        kodeSales: this.sales_detail.kode_sales
                    };
                },
                /**
                 * Modal Handler.
