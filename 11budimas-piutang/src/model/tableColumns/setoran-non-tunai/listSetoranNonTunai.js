...
export const listSetoranNonTunaiColumn = [
  ...
  columnHelper.display({
    ...
    header: "Action",
    cell: (info) => {
      const { nama_sales, draft_tanggal_input: tanggal, status_setoran } = info.row.original;
      ...
      return h(RouterButton, {
        to: `/setoran-non-tunai/list-faktur?sales=${nama_sales}&tanggal=${tanggal}`,
