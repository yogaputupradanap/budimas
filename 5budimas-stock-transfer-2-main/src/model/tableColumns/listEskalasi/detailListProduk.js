...
export const detailListProdukEskalasi = [
        ...
        cell: (info) =>
          h(T, () =>
            h(TableInput, {
              ...
              row: info.row.index,
              initialValue: info.row.original.carton_diterima,
              type: "number",
            })
          ),
      }),
        ...
        cell: (info) =>
          h(T, () =>
            h(TableInput, {
              ...
              column: info.column.id,
              row: info.row.index,
              initialValue: info.row.original.box_diterima,
              type: "number",
            })
          ),
      }),
        ...
        cell: (info) =>
          h(T, () =>
            h(TableInput, {
              ...
              column: info.column.id,
              row: info.row.index,
              initialValue: info.row.original.pieces_diterima,
              type: "number",
            })
          ),
      }),
