            ...
            <form action="/konfirmasi-order/store" method="post">
                    ...
                    <div class="form row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Kode <em>Request</em></label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" value="1" class="form-control-modal" placeholder="-" readonly>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Kode <em>Purchase</em></label>
                ...
                <div class="modal-body border-top">
                    <div class="form row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>PIC <em>Finance</em></label>
                                <select2 :options="user1.data" v-model.sync="user1.id" name="idUser1" required></select2>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>PIC <em>Auditing</em></label>
                                <select2 :options="user1.data" v-model.sync="user1.id" name="idUser1" required></select2>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" v-model="tanggal" class="form-control-modal datepicker" placeholder="YYYY-MM-DD">
                            </div>
                        </div>
                </div>
                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th>Jumlah <em>Diterima</em></th>
                                    <th>Jumlah <em>Fulfill**</em></th>
                                    <th>Jumlah <em>Sisa**</em></th>
                                </tr>
                            </thead>
                    ...
                    <div class="form row mt-3 m-0">
                        <div class="col-md-6">
                            <div class="form-group px-0">
                                <label><em>**) Jumlah Setelah Penerimaan Barang</em></label>
                            </div>
                        </div>
                        <div class="col-md-6">
