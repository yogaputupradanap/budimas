...
<template>
  <div class="tw-w-full tw-flex tw-flex-col tw-gap-2">
    ...
    <div
      ...
      :class="[
        'tw-w-full tw-border tw-border-slate-500 tw-select-none tw-rounded-md tw-relative tw-px-2 tw-flex tw-justify-between tw-items-center tw-cursor-pointer',
        selectInputSize,
      ]">
      <div
        @click="openOptions"
        ...
        <span
          ...
          :key="text"
          :title="text"
          class="tw-py-1 tw-px-2 tw-rounded-2xl tw-flex tw-justify-center tw-items-center tw-border tw-border-slate-400">
