                ...
                <div class="modal-body">
                    <div class="form row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label>Telepon</label>
                                <input type="number" name="telepon" v-model="telepon" class="form-control-modal"
                                    maxlength="13"
        ...
        var app_form = new Vue({
            ...
            data: function() {
                return {
                    // URL untuk Akses ke Resources.
                    url: {
                        store: "/olah-cabang/insert",
                        edit: "/olah-cabang/update",
                        delete: "/olah-cabang/delete",
                    },
                    // Instance Elemen.
                    form: () => {
