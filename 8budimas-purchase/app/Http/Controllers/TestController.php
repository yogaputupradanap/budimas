...
use App\Models\PurchaseTagihanPelunasan;
use App\Models\User;
...
class TestController extends Controller
{
    ...
    function test(Request $data)
    {
        ...
        return response()->json((new PurchaseTagihanPelunasan)->getListByIdOrder($data->idOrder));
    }
    ...
    //     // ->put('https://api-purchase-189463082311.asia-southeast2.run.app/api/base/users', $data);

    //     // $a = Http::withToken('A')
    //     // ->get('https://api-purchase-189463082311.asia-southeast2.run.app/api/base/users?q={"where":{"id":"2"}}')->object()->response;
