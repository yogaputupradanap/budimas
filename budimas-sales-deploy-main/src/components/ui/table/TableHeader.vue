...
<template>
  <thead :class="['tw-text-xs tw-sticky tw-top-0 tw-bg-white tw-z-10', classic && 'tw-border tw-border-slate-300',]">
    <tr
      :class="[!classic && 'tw-shadow-md tw-shadow-black/5']"
      ...
      <th
        ...
        :class="[
          ...
          classic && 'tw-border tw-border-slate-300',
        ]"
