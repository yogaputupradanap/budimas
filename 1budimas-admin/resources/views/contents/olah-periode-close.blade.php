                    ...
                    <div class="form row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label>Tanggal Periode Closed</label>
                                <datepicker v-model="tanggalClose"
                                            format="yyyy-MM-dd" required
                                            placeholder="Masukkan Tanggal Periode Close {{ $content->name }} (yyyy-mm-dd)">
                                </datepicker>
                            </div>
                            <div class="form-group">
        ...
        var app_list = new Vue({
            ...
            data: function () {
                return {
                    ...
                    url: {
                        show: req('/getPeriodeClosedTable')
                    },
                    // Instance Elemen.
            ...
            mounted: function () {
                ...
                this.table().on('click', '.btn-delete', (e) => {
                    ...
                    const rowData = this.table().DataTable().row(row)
                        .data();
                    app_form.delete(rowData.id_periode);
                });
            }
        });
    </script>
            ...
            data: function () {
                return {
                    ...
                    url: {
                        ...
                        store: "/olah-periode-close/insert",
                        edit: "/olah-periode-close/update",
                        delete: "/olah-periode-close/delete",
                    },
                    // Instance Elemen.
                    form: () => {
            ...
            methods: {
                ...
                getData: function (data) {
                    return {
                        ...
                        tanggalClose: this.tanggalClose,
