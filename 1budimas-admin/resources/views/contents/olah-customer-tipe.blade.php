            ...
            <div class="card form" id="app">
                ...
                <div class="card-body card-bar-menu">
                    <div class="btn-group" role="group">
                        <a class="btn btn-danger" href="/olah-customer">
    ...
    var app = new Vue({ 
        ...
        data    : function() {
            return {
                ...
                url   : { 
                    show   : "/olah-customer/tipe/data/table",
                    store  : "/olah-customer/tipe/insert",
                    edit   : "/olah-customer/tipe/update",
                    delete : "/olah-customer/tipe/delete",
                },
                // Instance Elemen.
