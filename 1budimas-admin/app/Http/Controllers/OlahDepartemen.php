...
class OlahDepartemen extends Controller {
    /**
     * Melakukan Request Action Insert.
     * @param Illuminate\Http\Request|$data Requested HTTP Form Data.
     */
    public function store(Request $data) {
        return (new Departemen)->insert($data)->response();
    }
    ...
    public function update(Request $data) {
        return (new Departemen)->updateById($data)->response();
    }
    ...
    public function destroy(Request $data) {
        return (new Departemen)->deleteById($data)->response();
    }
    ...
    function showOptionData() {
        return option((new Departemen)->all(), ['nama']);
    }
    ...
    function showTableData() {
        ...
        return DataTables::of((new Departemen)->all())
            ->addColumn('', fn() => "")
