...
class piutang extends baseService {
  constructor() {
    ...
    this.baseUrl = `/api/akuntansi/get-piutang`;
    this.tagihanSales = `/api/akuntansi/get-tagihan-sales`;
    this.detailTagihanNotaURL = `/api/base/sales_order/all?columns=${columnDTN}&join=${joinDTN}&on=${onDTN}`;
    this.detailTagihanSales = `/api/akuntansi/detail-tagihan-sales`;
    this.createTagihanSales = `/api/akuntansi/create-tagihan-sales`;
