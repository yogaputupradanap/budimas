...
export const kodePromoDummy = generateDummmy(["kode_promo", "id"]);
...
export const listMasterPromoDummy = generateDummmy([
  'kode_promo',
  'nama',
  'principal',
  'limit',
...
export const listLogPenggunaanPromoDummy = generateDummmy([
  'no_faktur',
  'kode_promo',
  'nama_promo',
  'principal',
...
export const listKlaimPromoDummy = generateDummmy([
  'no_klaim',
  'kode_promo',
  'nama_promo',
  'principal',
...
export const detailPromoDummy = {
  nama_promo: "Promo 1",
  nominal_promo: "30.000",
  tipe_promo: "3",
  kategori_promo: "Kategori 1",
  status_promo: "Aktif",
  principal: "PT Principal Satu",
  limit: "30.000.000",
  tanggal_mulai: "11/11/2024",
  tanggal_selesai: "12/12/2024",
  syarat_ketentuan: "blbalbalaabaa",
  syarat_wajib: "blablabalablaba",
  lampiran: "file.pdf",
};


export const ajukanKlaimDummy = generateDummmy([
  "no_faktur",
  "customer",
  "estimate_klaim",
  "status",
...
export const detailKlaimPromoDummy = generateDummmy([
  "no_faktur",
  "customer",
  "jumlah_klaim",
  "estimate_klaim",
