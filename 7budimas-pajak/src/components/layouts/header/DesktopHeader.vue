...
<template>
  <header
    id="header-wrapper"
    class="tw-w-full tw-h-16 tw-bg-white tw-hidden lg:tw-flex tw-justify-between tw-items-center lg:tw-sticky tw-top-0 tw-z-50 tw-px-4">
    <ClockAndToggle />
    <div
      ...
      <UserInfo
        ...
        :user-info="user?.user?.value?.[userInfos[idx]] || ''" />
