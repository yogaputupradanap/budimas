...
function minggu($id) {
    switch ($id) {
        ...
        case 5  : return "1 dan 2";  break;
        case 6  : return "1 dan 3";  break;
        case 7  : return "1 dan 4";  break;
        case 8  : return "2 dan 3";  break;
        case 9  : return "2 dan 4";  break;
        case 10 : return "3 dan 4";  break;
        case 11 : return "Semua";  break;
        default : break;
    }
}
...
function tipe_kunjungan($id) {
    switch ($id) {
        case 1  : return 'Terjadwal';        break;
        case 2  : return 'Tidak Terjadwal';  break;
        case 3  : return 'Spesial/Pengganti';  break;
        default : break;
    }
}
 ...
 */
function option($collections, $keys, $full = false, $id = null) {
    // Formatitng Collections of Data
    $collections = !is_array($collections) 
                   ? array($collections) 
                   : $collections;

    // Formatting Option of Data
    $options = collect($collections)->map(
        function($item) use ($keys, $id) {    
            $text = '';
