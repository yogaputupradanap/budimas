...
<template>
  <div class="tw-w-full tw-flex tw-flex-col tw-gap-2">
    ...
    <div
      ...
      :class="[
        'tw-w-full tw-border tw-border-gray-300 hover:tw-border-gray-400 tw-rounded-md hover:tw-bg-gray-50 focus:tw-outline-none focus:tw-ring-4 focus:tw-ring-blue-200 tw-relative tw-px-2 tw-flex tw-justify-between tw-items-center tw-cursor-pointer',
        selectInputSize,
      ]">
      <div
        @click="openOptions"
        ...
        <span
          ...
          :key="text"
          :title="text"
          class="tw-py-1 tw-truncate tw-px-2 tw-rounded-lg tw-flex tw-justify-center tw-items-center tw-border tw-border-slate-400">
          {{ text }}
        </span>
      ...
      <Transition @enter="enter" @leave="leave">
        <div
          ...
          <BFormInput
            ...
            class="tw-h-7 tw-mb-3 placeholder:tw-text-sm tw-text-sm"
            placeholder="cari ..." />
          <div
