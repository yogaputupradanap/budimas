...
class OlahProdukBrand extends Controller {
    /**
     * Menampilkan Master Page.
     * @param array|$nav Keterangan Breadcrumb Navigations.
     */
    public function index() {
        return view('contents.olah-produk-brand', [
            'content' => (object) [
                'name'       => 'Produk Brand',
                'breadcrumb' => ['Olah Produk', 'Daftar Produk', 'Daftar Produk Brand']
            ]
        ]);
    }
    ...
    public function store(Request $data) {
        return (new ProdukBrand)->insert($data)->response();
    }
    ...
    public function update(Request $data) {
        return (new ProdukBrand)->updateById($data)->response();
    }
    ...
    public function destroy(Request $data) {
        return (new ProdukBrand)->deleteById($data)->response();
    }
    ...
    function showOptionData() {
        return option((new ProdukBrand)->all(), ['nama']);
    }
    ...
    function showTableData() {
        ...
        return DataTables::of((new ProdukBrand)->all())
            ->addColumn('', fn() => "")
