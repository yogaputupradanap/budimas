                    ...
                    <div class="form row">
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" v-model="tanggal" class="form-control-modal datepicker"
                        ...
                        <div class="col-md-4 px-3">
                            <div class="form-group">
                                <label>Cabang</label>
                                <input type="text" v-model="cabang" class="form-control-modal"
                                    placeholder="Masukkan Cabang" readonly>
                            </div>
                            <div class="form-group">
                                <label>Keterangan</label>
                                <input type="text" v-model="keterangan" class="form-control-modal"
                                    placeholder="Masukkan Keterangan" readonly>
                            </div>
                        </div>
                        <div class="col-md-4 px-3">
                            <div class="form-group">
                                <label>Principal</label>
                                <input type="text" v-model="principal" class="form-control-modal"
                                    placeholder="Masukkan Principal" readonly>
                            </div>
                            <div class="form-group">
                                <label>User (PIC)</label>
                                <input type="text" v-model="user" class="form-control-modal" placeholder="Masukkan User"
                                    readonly>
                            </div>
                        </div>
                    </div>
...
@push('page_scripts')
    <script>
        ...
        var app_list = new Vue({
            ...
            data: function() {
                return {
                    ...
                    url: {
                        show: "purchase-order/data/table"
                    },
                    // Instances Data.
                    data: {
                        // Table Columns Data.
        ...
        var app_detail = new Vue({
            ...
            computed: {
                checkOrder: function() {
                    return this.collections.some(i => i.jumlah_sisa != 0);
                },
            },
        });
    </script>
