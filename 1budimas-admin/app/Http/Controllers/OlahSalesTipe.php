...
class OlahSalesTipe extends Controller {
    /**
     * Melakukan Request Action Insert.
     * @param Illuminate\Http\Request|$data Requested HTTP Form Data.
     */
    public function store(Request $data) {
        return (new SalesTipe)->insert($data)->response();
    }
    ...
    public function update(Request $data) {
        return (new SalesTipe)->updateById($data)->response();
    }
    ...
    public function destroy(Request $data) {
        return (new SalesTipe)->deleteById($data)->response();
    }
    ...
    function showOptionData() {
        return option((new SalesTipe)->all(), ['nama']);
    }
    ...
    function showTableData() {
        ...
        return DataTables::of((new SalesTipe)->all())
            ->addColumn( '',         fn()   => ""                                        )
