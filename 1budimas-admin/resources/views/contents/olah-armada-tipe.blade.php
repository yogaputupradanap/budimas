            ...
            <div class="card form" id="app">
                ...
                <div class="card-body card-bar-menu">
                    <div class="btn-group" role="group">
                        <a class="btn btn-danger" href="/olah-armada">
    ...
    var app = new Vue({ 
        ...
        data    : function() {
            return {
                ...
                url   : { 
                    show   : "/olah-armada/tipe/data/table",
                    store  : "/olah-armada/tipe/insert",
                    edit   : "/olah-armada/tipe/update",
                    delete : "/olah-armada/tipe/delete",
                },
                // Instance Elemen.
