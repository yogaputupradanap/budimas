                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" v-model="kode" class="form-control-modal" maxlength="25"
                                    placeholder="Masukkan Kode {{ $content->name }} (Max 25 Karakter)" required>
                            </div>
                            <div class="form-group">
                                <label>Nama Rute</label>
                                <input type="text" v-model="nama_rute" class="form-control-modal" maxlength="100"
                                    placeholder="Masukkan Nama Rute {{ $content->name }} (Max 100 Karakter)" required>
                            </div>
                            <div class="form-group">
                                <label>Cabang</label>
                            ...
                            {{-- <div class="form-group">
                                ...
                                <input type="number" v-model="prioritas" class="form-control-modal"
                                    placeholder="Masukkan Prioritas {{ $content->name }}">
                            </div> --}}
                            <div class="form-group">
                                <label>Deskripsi</label>
                                <input type="text" v-model="deskripsi" class="form-control-modal" maxlength="100"
                                    placeholder="Masukkan Deskripsi {{ $content->name }} (Max 100 Karakter)">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        var app_form = new Vue({
            ...
            data: function() {
                return {
                    ...
                    url: {
                        ...
                        store: "/olah-rute/insert",
                        edit: "/olah-rute/update",
                        delete: "/olah-rute/delete",
                    },
                    // Instance Elemen.
                    form: () => {
            ...
            methods: {
                ...
                setData: function(data) {
                    this.id = data.id;
                    this.cabang.id = data.id_cabang; // Simplified assignment
                    this.kode = data.kode;
                    this.nama_rute = data.nama_rute;
