            ...
            <div class="card form" id="app">
                ...
                <div class="card-body card-bar-menu">
                    <div class="btn-group" role="group">
                        <a class="btn btn-danger" href="/olah-plafon">
                    ...
                    <div class="form row">
                        <div class="col-6">
                            <div class="form-group">
                                <label>Minggu</label>
                                <input type="number" v-model="minggu" class="form-control-modal" maxlength="1" min="1" max="4" placeholder="Masukkan Minggu {{ $content->name }}" required>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                <label>Tanggal</label>
                                <datepicker v-model="tanggal" placeholder="Masukkan Tanggal {{ $content->name }}" required></datepicker>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group">
    ...
    var app = new Vue({ 
        ...
        data    : function() {
            return {
                ...
                url   : { 
                    show   : "/olah-plafon/week/data/table",
                    store  : "/olah-plafon/week/insert",
                    edit   : "/olah-plafon/week/update",
                    delete : "/olah-plafon/week/delete",
                },
                // Instance Elemen.
