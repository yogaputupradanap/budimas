                                ...
                                <table class="table table-bordered w-200">
                                    <thead>
                                        <tr class="text-center">
                                            ...
                                            <th colspan="4"> UOM <em>Level 1</em>     </th>
                                            <th colspan="4"> UOM <em>Level 2</em>     </th>
                                            <th colspan="4"> UOM <em>Level 3</em>     </th>
                                            <th rowspan="2"> Hapus <br>Item           </th>
                                        </tr>
                                        <tr>
                                            <th> Kode                       </th>
                                            <th> Nama                       </th>
                                            ...
                                            <th> Jumlah <em>Order</em>      </th>
                                            <th> Subtotal <em>Order</em>    </th>
                                            <th> Ket. <em>UOM</em>          </th>
                                            <th> Harga Beli + PPN           </th>
                                            <th> Jumlah <em>Order</em>      </th>
                                            <th> Subtotal <em>Order</em>    </th>
                                    ...
                                    <tbody>
                                        <tr v-for="(item, index) in produk.table.data" :key="item.id">
                                            ...
                                            <td> 
                                                <b>[@{{ item.level_produk_uom }}] [@{{ item.kode_produk_uom }}] @{{ item.nama_produk_uom }}</b>
                                                ...
                                                <input type="hidden" name="subtotalOrder1[]">
                                            </td>
                                            <td> @{{ item.harga_beli_produk_dikonversi }}                               </td>
                                            <td width="7%"> <input type="text" class="form-control-modal" name="jumlahOrder1[]"> </td>
                                            <td> @{{ item.harga_beli_produk_dikonversi }} </td>
                                            <td> 
                                                <b>[@{{ item.level_produk_uom }}] [@{{ item.kode_produk_uom }}] @{{ item.nama_produk_uom }}</b>
                                                <input type="hidden" name="idProdukUOM[]"             :value="item.id_produk_uom">
                                                ...
                                                <input type="hidden" name="levelProdukUOM[]"          :value="item.level_produk_uom">
                                                <input type="hidden" name="faktorKonversiProdukUOM[]" :value="item.faktor_konversi_produk_uom">
                                                <input type="hidden" name="subtotalOrder2[]">
                                            </td>
                                            <td> @{{ item.harga_beli_produk_dikonversi }}                               </td>
                                            <td width="7%"> <input type="text" class="form-control-modal" name="jumlahOrder2[]"> </td>
                                            <td> @{{ item.harga_beli_produk_dikonversi }} </td>
                                            <td> 
                                                <b>[@{{ item.level_produk_uom }}] [@{{ item.kode_produk_uom }}] @{{ item.nama_produk_uom }}</b>
                                                <input type="hidden" name="idProdukUOM[]"             :value="item.id_produk_uom">
                                                ...
                                                <input type="hidden" name="levelProdukUOM[]"          :value="item.level_produk_uom">
                                                <input type="hidden" name="faktorKonversiProdukUOM[]" :value="item.faktor_konversi_produk_uom">
                                                <input type="hidden" name="subtotalOrder3[]">
                                            </td>
                                            <td> @{{ item.harga_beli_produk_dikonversi }}                               </td>
                                            <td width="7%"> <input type="text" class="form-control-modal" name="jumlahOrder2[]"> </td>
                                            <td> @{{ item.harga_beli_produk_dikonversi }} </td>
    ...
    var app_produk = new Vue({ 
        ...
        methods : {
            setSatuan   : function(id, vm = this) {
                ...
                $.post(this.url.show3, {idProduk:id}).done((data) => { 
                    console.log(data);
                });
            },
            setSatuanA  : function(){
