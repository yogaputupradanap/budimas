  ...
  actions: {
    ...
    async getAllVouchersForProduct(productId) {
      ...
      try {
        ...
        // Dapatkan ID cabang yang diperlukan
        ...
        await this.getVoucher2Product(productId, branchId);
        console.log('Voucher 3 skipped - no customer selected');
    ...
    async getVoucher1Regular() {
      ...
      try {
        ...
        console.log('Fetched Voucher 1 Regular:', response);
    ...
    async getVoucher2Regular() {
      ...
      try {
        ...
        console.log('Fetched Voucher 2 Regular:', response);
